    ...
    <div class="grid">
        <div class="col-12 md:col-6 xl:col-3">
            <div class="card h-full">
                <span class="font-semibold text-lg">Sales 334</span>
                <div class="flex justify-content-between align-items-start mt-3">
                    <div class="w-6">
                        <AnimatedCounter :value="120" tag="span" class="text-4xl font-bold text-900"></AnimatedCounter>
        ...
        <div class="col-12 md:col-6 xl:col-3">
            <div class="card h-full">
                ...
                <div class="flex justify-content-between align-items-start mt-3">
                    <div class="w-6">
                        <AnimatedCounter :value="4500" force tag="span" class="text-4xl font-bold text-900">$</AnimatedCounter>
                        <div class="text-green-500">
        ...
        <div class="col-12 md:col-6 xl:col-3">
            <div class="card h-full">
                ...
                <div class="flex justify-content-between align-items-start mt-3">
                    <div class="w-6">
                        <AnimatedCounter :value="360" tag="span" class="text-4xl font-bold text-900"></AnimatedCounter>
