      ...
      <div class="max-w-7xl mx-auto">
        <div class="flex align-items-center justify-content-between mb-6">
          ...
          <div class="flex align-items-center space-x-4">
            <!-- View Toggle -->
            <div class="flex align-items-center bg-gray-100 border-round-lg p-1">
              <button @click="viewMode = 'cards'"
                      class="p-2 border-round-md border-0 transition-colors"
                      :class="viewMode === 'cards' ? 'bg-white text-blue-600 shadow' : 'hover:bg-gray-50'">
                <span class="material-icons">grid_view</span>
              </button>
              <button @click="viewMode = 'list'"
                      class="p-2 border-round-md transition-colors"
        ...
        <!-- Tabs -->
        <div class="bg-white border-round-lg shadow-3 border-1 mb-6">
          ...
          <div class="p-4">
            <div class="relative">
              <input
                v-model="searchQuery"
                type="text"
                class="w-full pl-10 pr-4 py-2 border-round-lg border-1"
