  ...
  <div class="customer-management p-4">
    ...
    <div class="mb-4 flex justify-content-between align-items-center">
      ...
      <div class="flex gap-2">
        <Button
          icon="pi pi-list"
          :class="{ 'p-button-primary': currentView === 'list' }"
          @click="currentView = 'list'"
        />
        <Button
          icon="pi pi-th-large"
          :class="{ 'p-button-primary': currentView === 'grid' }"
    ...
    <ScrollPanel class="w-full">
          ...
          <Column header="Action">
            <template #body="slotProps">
              <Button
                icon="pi pi-eye"
                label="Select"
                @click="handleSelectCustomer(slotProps.data)"
      ...
      >
        <Card
          ...
          :key="customer.id"
          class="card-style p-4 bg-white shadow rounded"
        ...
        >
          <template #content>
            <div class="p-4">
              ...
              <p v-if="customer.plateNo" class="text-sm text-gray-500 text-center mb-1">
                Plate No: {{ customer.plateNo }}
              </p>
        ...
        <div :class="{ 'grid grid-cols-2 gap-4': customerType === 'business' }">
          <div class="space-y-4">
            ...
            <div class="flex flex-column gap-2">
              ...
              <InputText
                id="plateNo"
                v-model="newCustomer.plateNo"
                @input="handleInputChange('plateNo', $event.target.value)"
              />
            </div>
          ...
          <div v-if="customerType === 'business'" class="space-y-4">
            <div class="flex flex-column gap-2">
              ...
              <InputText
                id="cr"
                v-model="newCustomer.cr"
                @input="handleInputChange('cr', $event.target.value)"
              />
            </div>
            ...
            <div class="flex flex-column gap-2">
              ...
              <InputText
                id="vatRegNo"
                v-model="newCustomer.vatRegNo"
                @input="handleInputChange('vatRegNo', $event.target.value)"
              />
            </div>
          </div>
        </div>
