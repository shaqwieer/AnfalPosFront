    ...
    <div class="w-full" v-if="currentView == 'list'">
      ...
      >
        ...
        <Column field="currentStatus" :header="'Status'" class="" :sortable="true">
          <template #body="slotProps">
            <div class="flex flex-row align-items-center">
              <Tag :severity="slotProps.data.ivoiceStatus == 'UnderRevision' ? 'warning' : slotProps.data.ivoiceStatus == 'Created' ? 'success' : 'danger'" :value="slotProps.data.ivoiceStatus"></Tag>
            </div>
          </template>
        </Column>
